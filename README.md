...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/robotframework-databaselibrary-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/robotframework-databaselibrary-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add robotframework-databaselibrary
# for installing globally
pixi global install robotframework-databaselibrary
```
...
It is possible to list all of the versions of `robotframework-databaselibrary` available on your platform:
...
```
pixi search robotframework-databaselibrary --channel conda-forge
```
